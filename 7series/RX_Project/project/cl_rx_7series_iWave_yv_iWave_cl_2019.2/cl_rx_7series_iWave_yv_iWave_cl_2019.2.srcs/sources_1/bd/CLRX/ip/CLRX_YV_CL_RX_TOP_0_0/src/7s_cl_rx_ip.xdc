...
#set_false_path -from [get_ports {serial_*_*[*]}] -to [get_pins -hier -filter {name =~ *YV_TOP*/D_Top*/deserializer_inst/deserializer_1to7_inst_*/iserdes_ddr*/D}]
...
#set_false_path -from [get_ports clk_*_p] -to [get_pins -hier -filter {name =~ *iserdes_*/D}]
...
set_false_path -from [get_pins -hier -filter {name =~ *YV_TOP*/D_Top*/dser_mmcm_inst/tap*/C}] -to [get_pins -hier -filter {name =~ *YV_TOP*/YV_GPIO_s_axi_U/int_in*_V_reg[*]/D}]
set_false_path -from [get_pins -hier -filter {name =~ *YV_TOP*/D_Top*/dser_mmcm_inst/px_data_reg[*]/C}] -to [get_pins -hier -filter {name =~ *YV_GPIO*/YV_GPIO_s_axi_U/int_in*_V_reg[*]/D}]

##---
set_false_path -from [get_pins -hier -filter {name =~ *YV_TOP*/D_Top*/dser_mmcm_inst/tap*/C}] -to [get_pins -hier -filter {name =~ *YV_GPIO*/YV_GPIO_s_axi_U/int_in*_V_reg[*]/D}]
set_false_path -from [get_pins -hier -filter {name =~ *YV_TOP*/D_Top*/dser_mmcm_inst/px_data_reg[*]/C}] -to [get_pins -hier -filter {name =~ *YV_GPIO*/YV_GPIO_s_axi_U/int_in*_V_reg[*]/D}]

set_false_path -from [get_pins -hier -filter {name =~ *idelay*/CLK}] -to [get_pins -hier -filter {name =~ *YV_GPIO*/YV_GPIO_s_axi_U/int_in*_V_reg[*]/D}]
set_false_path -from [get_pins -hier -filter {name =~ *YV_GPIO*/YV_GPIO_s_axi_U/int_out*_V_reg[*]/C}] -to [get_pins -hier -filter {name =~  *rx_adap*/cl_sync_capture*/mem_line/gnuram_async_fifo.xpm_fifo_base_inst/gen_sdpram.xpm_memory_base_inst/gen_wr_a.gen_word_narrow.mem_reg*/RAM*/WE}]
#set_false_path -from [get_pins -hier -filter {name =~ *YV_GPIO_s_axi_U*/int_out*_V_reg*/C}] -to [get_pins -hier -filter {name =~ *cl_sync_capture_*/mem_line/gnuram_async_fifo.xpm_fifo_base_inst/gen_sdpram.xpm_memory_base_inst/gen_wr_a.gen_word_narrow.mem*/RAM*/WE}]

set_false_path -from [get_pins -hier -filter {name =~ *YV_TOP*/hash_dna/DNA_i/SLR_tmp_reg[*]/C}] -to [get_pins -hier -filter {name =~ *YV_TOP*/D_Top*/dser_mmcm_inst/rx_reset_sync_reg[*]/PRE}]
set_false_path -from [get_pins -hier -filter {name =~ *YV_GPIO*/YV_GPIO_s_axi_U/int_out*_V_reg[*]/C}] -to [get_pins -hier -filter {name =~ *YV_TOP*/D_Top*/dser_mmcm_inst/rx_reset_sync_reg[*]/PRE}]
set_false_path -from [get_pins -hier -filter {name =~ *YV_TOP*/hash_dna/DNA_i/SLR_tmp_reg[*]/C}] -to [get_pins -hier -filter {name =~ *YV_TOP*/D_Top*/dser_mmcm_inst/rx_ready*/D}]
set_false_path -from [get_pins -hier -filter {name =~ *YV_GPIO*/YV_GPIO_s_axi_U/int_out*_V_reg[*]/C}] -to [get_pins -hier -filter {name =~ *YV_TOP*/D_Top*/deserializer_inst/deserializer_1to7_inst_*/rx_wr_data_reg[*]/D}]
set_false_path -from [get_pins -hier -filter {name =~ *YV_TOP*/D_Top*/dser_mmcm_inst/px_ready_reg/C}] -to [get_pins -hier -filter {name =~ *YV_GPIO*/YV_GPIO_s_axi_U/int_in*_V_reg[*]/D}]
