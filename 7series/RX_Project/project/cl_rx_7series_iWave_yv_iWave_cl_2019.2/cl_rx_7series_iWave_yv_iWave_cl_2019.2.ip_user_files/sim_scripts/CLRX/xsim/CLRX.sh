...
xv_boost_lib_path=/opt/XilinxTools/2019.2/Vivado/2019.2/tps/boost_1_64_0
...
{
  file="xsim.ini"
  lib_map_path="/opt/XilinxTools/2019.2/Vivado/2019.2/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb CLRX.wdb xsim.dir)
